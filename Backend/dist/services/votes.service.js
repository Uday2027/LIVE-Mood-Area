...
export const recalculateCredibility = async (pinId) => {
...
export const castVote = async (params) => {
    ...
    if (pin === null)
        throw new AppError('Pin not found or has expired', 404);
    if (pin.sessionId === sessionId)
        throw new AppError('You cannot vote on your own pin', 403);
    try {
