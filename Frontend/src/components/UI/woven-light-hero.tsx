...
export const WovenLightHero = () => {
  ...
  const headline = "MoodMap";
  
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-black dark:bg-white text-white">
      <WovenCanvas />
      <HeroNav />
      <div className="relative z-10 text-center px-4">
        ...
        >
          Real-Time Crowd Mood Tracker. See the vibe of your city, right now. 
          Anonymously share and discover the atmosphere of any neighborhood in seconds.
        </motion.p>
        ...
        >
            <div className="max-w-7xl mx-auto flex justify-between items-center text-white">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-xl font-bold text-white dark:text-slate-800" style={{ fontFamily: "'Inter', sans-serif" }}>MoodMap</span>
                </div>
            </div>
        </motion.nav>
    );
